...
import com.cong.chenchong.wifi.manager.UiUpdater;
...
public class WiFiActivity extends SlidingActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setText(R.id.txt_title, getIntent().getStringExtra("title"));
    ...
    public void updateUi() {
        ...
        setText(R.id.wifi_name, isWifiReady ? wifiId : getString(R.string.no_wifi_hint));
    ...
    /*
     * OnClickListener startStopListener = new OnClickListener() { public void
     * onClick(View v) { Globals.setLastError(null); File chrootDir = new
     * File(Defaults.chrootDir); if (!chrootDir.isDirectory()) return; Context
     * context = mActivity.getApplicationContext(); Intent intent = new
     * Intent(context, FTPServerService.class); Globals.setChrootDir(chrootDir);
     * if (!FTPServerService.isRunning()) { warnIfNoExternalStorage(); if
     * (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState()))
     * { context.startService(intent); } } else { context.stopService(intent); }
     * } };
     */
