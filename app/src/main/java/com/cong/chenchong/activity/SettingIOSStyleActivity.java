...
public class SettingIOSStyleActivity extends SlidingActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_setting_ios_style);
	...
	private void initView() {
		...
		mItemViewData.setItemView(new SwitchItemView(SettingIOSStyleActivity.this));
		...
		mItemViewData.setData(mItemData);
		mItemViewData.setItemView(new BasicItemViewH(SettingIOSStyleActivity.this));
		mListData.add(mItemViewData);
