...
public class ElasticScrollWrapLayout extends LinearLayout {
    ...
    public ElasticScrollWrapLayout(Context context, AttributeSet attr) {
        super(context, attr);
    ...
    public ElasticScrollWrapLayout(Context context) {
        super(context);
        this.setOrientation(LinearLayout.VERTICAL);
        // 初始化平滑滚动器
        mScroller = new Scroller(getContext(), new OvershootInterpolator(OVERSHOOT_TENSION));
