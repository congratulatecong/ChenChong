...
public class SmileView extends LinearLayout implements Animator.AnimatorListener {
    ...
    public void setLike(int like) {
        likeNum.setText(TextUtils.concat(String.valueOf(like), "%"));
    }

    public void setDisLike(int dislike) {
        disNum.setText(TextUtils.concat(String.valueOf(dislike), "%"));
    }
    ...
    private void init() {
        ...
        String defaultDislike = "无感";
        disText.setText(defaultDislike);
        ...
        disBack.setBackgroundResource(R.drawable.bg_rectangle_white);
        likeBack.setBackgroundResource(R.drawable.bg_rectangle_white);

        //单列总布局
        LinearLayout likeAll = new LinearLayout(getContext());
        LinearLayout disAll = new LinearLayout(getContext());
    ...
    private void bindListener() {
        imageDis.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                type = 1; //设置动画对象
                animBack(); //拉伸背景
                setVisibilities(VISIBLE); //隐藏文字
                //切换背景色
                setBackgroundColor(Color.parseColor(defaultShadow));
                likeBack.setBackgroundResource(R.drawable.bg_rectangle_white);
                disBack.setBackgroundResource(R.drawable.bg_rectangle_accent);
                //重置帧动画
        ...
        imageLike.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                setBackgroundColor(Color.parseColor(defaultShadow));
                disBack.setBackgroundResource(R.drawable.bg_rectangle_white);
                likeBack.setBackgroundResource(R.drawable.bg_rectangle_accent);
