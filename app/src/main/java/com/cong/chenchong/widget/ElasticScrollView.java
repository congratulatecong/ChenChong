 ...
 * <strong>策略:</strong> 获取ScrollView的子视图并添加到自定义的{@link ElasticScrollWrapLayout}滚动视图中
 * 将滚动视图添加到ScrollView作为子视图,所有的弹性滚动都由{@link ElasticScrollWrapLayout}来完成
 *
 * @author King
 */
public class ElasticScrollView extends ScrollView {
	 ...
	 * 自定义的弹性滚动视图
	 */
	private ElasticScrollWrapLayout mContentLayout;
	...
	private void initOverScrollLayout() {
		...
		if(mContentLayout == null){
			...
			// 初始化弹性滚动视图
			mContentLayout = new ElasticScrollWrapLayout(getContext());
			// 移除ScrollView所有视图
			this.removeAllViews();
