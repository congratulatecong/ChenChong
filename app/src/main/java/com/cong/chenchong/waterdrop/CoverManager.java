...
public class CoverManager {
    ...
    public void finish(final View target, final float x, final float y) {
        /**
         * if click very quick. Drop may be finished before first frame. It will
         * cause SurfaceView render error. [java.lang.NullPointerException:
         * Attempt to invoke interface method 'void
         * android.view.ViewParent.requestTransparentRegion(android.view.View)'
