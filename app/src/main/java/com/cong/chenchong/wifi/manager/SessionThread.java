...
package com.cong.chenchong.wifi.manager;


import com.cong.chenchong.util.RemoteUtil;
import com.cong.chenchong.wifi.cmd.FtpCmd;
...
public class SessionThread extends Thread {
   ...
   // protected MyLog myLog = new MyLog(getClass().getName());
     ...
     */
    public int receiveFromDataSocket(byte[] bytes) {
        int bytesRead;
